...
**כניסה לאירוע:**
- סריקת QR או לחיצה על קישור → `memoria-share-c.vercel.app/EventGallery?code=XXXX`
- ללא צורך בהתחברות לצורך צפייה בסיסית והעלאה (device_uuid אנונימי)
...
| לשונית | מה מוצג |
|---|---|
| **התמונות שלי** | כל תמונות המשתמש הנוכחי, כולל ממתינות לאישור ומוסתרות |
| **גלריה משותפת** | תמונות מאושרות (`is_hidden=false`) + תמונות המשתמש עצמו |

- ספירת תמונות בתג על כל לשונית
- PhotoViewer מלא עם ניווט swipe ומקלדת
- אפשרות לבקש מחיקת תמונה
