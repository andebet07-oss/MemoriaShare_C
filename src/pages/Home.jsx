    ...
    <div className="bg-gradient-to-br from-background via-cool-900 to-background text-foreground min-h-screen">
      ...
      {showDemo && (
        <div className="fixed inset-0 bg-background/90 backdrop-blur-md z-[100] flex items-center justify-center p-4 animate-in fade-in duration-200" onClick={() => setShowDemo(false)} dir="rtl">
          <div className="bg-gradient-to-br from-cool-900 to-cool-950 rounded-[2rem] overflow-hidden max-w-4xl w-full max-h-[80vh] border border-border shadow-card-dark animate-in zoom-in-95 duration-300" onClick={e => e.stopPropagation()}>
            ...
            <div className="p-8">
              <div className="aspect-video bg-gradient-to-br from-cool-800 to-cool-950 rounded-2xl flex items-center justify-center border border-border shadow-inner">
                <div className="text-center">
                  ...
                  <Button
                    ...
                    className="btn-primary px-8 py-6 rounded-full font-bold text-lg w-full sm:w-auto"
                  >
                    התחילו ליצור אירוע
